...
# %%
# queste vanno cambiate per le varie ricostruzioni N1XN2 
N1 = 2 
N2 = 2 
# questa è la profondità aumentando N3 si hanno più layer 
# i layer sono 4 X N3 
N3 = 2 
# lunghezza della regione di vuoto in bohri 
vacuum = 10 
#
alat = 10.21 
...
unitcell = pmg.Structure(lattice=lattice, species=species , coords=coords, coords_are_cartesian=False)
...
# %%
sup1 = unitcell.copy()
sup1.make_supercell([[0,-N1,N1],[N2,0,0],[-1,1,1]], to_unit_cell = True)
...
sup1.composition, sorted(sup1.cart_coords, key=lambda x: x[2])
...
with open(f'posizioniSi100_{N1}X{N2}_{N3*4}_layer','w') as f:
...
surface.to(filename=f'surf_100_{N1}X{N2}_{4*N3}.cif')
